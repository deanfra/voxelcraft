...
function GUI({state}: Props) {
  ...
  const untoggleAll = () => {
    setShowCastlePanel(false)
    setShowHousePanel(false)
    setShowSlabsPanel(false)
  }
  const toggleCastlePanel = () => {
    untoggleAll()
    setShowCastlePanel(!showCastlePanel)
  }
  const toggleHousePanel = () => {
    untoggleAll()
    setShowHousePanel(!showHousePanel)
  }
  const toggleSlabsPanel = () => {
    untoggleAll()
    setShowSlabsPanel(!showSlabsPanel)
  }
